  ...
  // <script>
    ...
    AutoComplete.prototype = {
        ...
        renderInput: function () {
            var rawHtml =  '<span id="autocomplete" style="background-color:#eee;">' +
                                '<span id="autocomplete-delimiter"background-color:#ddd;padding: 0 2px;">' + this.options.delimiter + '</span>' +
                                '<span id="autocomplete-searchtext" style="padding:0 4px 0 2px;"><span class="dummy">\uFEFF</span></span>' +
                            '</span>';
        ...
        renderDropdown: function () {
            return '<ul class="mention-dropdown"><li class="load"></li></ul>';
        },
        ...
        offset: function () {
            var rtePosition = $(this.editor.getContainer()).offset(),
                ...
                toolbarHeight = ($('.mce-toolbar-grp').length > 0 && $('body').hasClass('wp-admin')) ? $('.mce-toolbar-grp').height() : 0;
            return {
                top: rtePosition.top + contentAreaPosition.top + nodePosition.top + $(this.editor.selection.getNode()).innerHeight() - $(this.editor.getDoc()).scrollTop() + 5 + toolbarHeight,
